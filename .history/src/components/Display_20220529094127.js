  ...
  <div className="d-flex vh-100 justify-content-center">
     <div className="d-flex justify-content-center align-items-center h-100" style={{backgroundColor:color,width:"100vw"}}> 
      ...
      ><i className="fa-brands fa-twitter"></i></button>
                <button className="btn btn-primary mx-1" ><i className="fa-brands fa-tumblr"></i></button>
                <div className='col-md' style={{direction:"rtl"}}><button className="btn btn-primary" onClick={handleClick}>New Quote</button></div>
               </div>
               </div> 
            </div>  
          </div>
