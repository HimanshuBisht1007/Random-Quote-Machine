        ...
        <div className="card text-white" style={{borderRadius: "15px"}}>
          ...
          <div className="container-fluid">
             <div className="row">
               ...
               <button className="btn btn-primary mx-1"style={{backgroundColor:color}}><a id = 'tweet-quote' itle="Tweet this quote!" target="_top"></a><i className="fa-brands fa-twitter"></i>
               </button>
