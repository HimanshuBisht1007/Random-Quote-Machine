        ...
        <div className="card text-white" style={{borderRadius: "15px"}}>
          ...
          <div className="container-fluid">
             <div className="row">
               ...
               <button className="btn btn-primary mx-1"style={{backgroundColor:color}}><a id = 'tweet-quote' title="Tweet this quote!" target="_top"></a><i className="fa-brands fa-twitter"></i>
               </button>
                <button className="btn btn-primary mx-1" style={{backgroundColor:color}}><i className="fa-brands fa-tumblr"><a id = "tumblr-quote" title="Tumblr this quote!" target="_blank"></a></i></button>
